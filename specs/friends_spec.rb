...
class TestFriends < MiniTest::Test
  ...
  def test_favourites_tv_show
    result = get_show(@person1)
    assert_equal("Friends", result)
  end

  # 3. For a given person, check if they like a particular food
  def test_likes_to_eat
    result = does_like_food(@person3, "Scooby snacks")
    assert_equal(true, result)
  end

  def test_likes_to_eat
    result = does_like_food(@person4, "Scooby snacks")
